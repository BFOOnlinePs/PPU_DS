                    ...
                    <a href="{{ route('admin.majors.index') }}" class="text-decoration-none">
                        <div class="bg-primary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span><strong>{{__('translate.Specializations management')}}{{--إدارة التخصصات--}}</strong></span>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('admin.companies_categories.index') }}" class="text-decoration-none">
                        <div class="bg-primary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span><strong> {{__('translate.Classification of companies')}} {{-- تصنيف الشركات --}}</strong></span>
                                </div>
                            </div>
                        </div>
                    </a>
