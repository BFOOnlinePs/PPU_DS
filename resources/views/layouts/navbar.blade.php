<div class="page-main-header">
    <div class="main-header-right row m-0" style="background-image: url('{{ asset('assets/images/img/header_bg.jpg') }}')">
      ...
      <div class="nav-right col pull-right right-menu p-0">
          <ul style="float: left" class="nav-menus mt-3">
                <li><p class="text-center text-white mt-2 text-bold" >{{ auth()->user()->name }}</p></li>
          ...
          <ul style="float: right" class="nav-menus">
                <li class="mt-2"><h3 class="text-white">البوابة الالكترونية :: كلية الدراسات الثنائية</h3></li>
          </ul>
      </div>
