        ...
        <div class="modal-content" style="border: none;">
            <div class="modal-header" style="height: 73px;">
                ...
                <div class="modal-body">
                    <div class="row p-3 m-5">
                        <div class="col-md-4 text-center" >
                            ...
                            <h3>إضافة مساعد إداري للمشرف الأكاديمي</h3>
                            <hr>
                            <p >في هذا القسم يمكن إضافة مساعد إداري للمشرف الأكاديمي</p>
                        </div>
                        <div class="col-md-8">
                            <form class="form-horizontal" enctype="multipart/form-data" id="addAssistantForm">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3 row">
                                            <label for="">المساعد الإداري :</label>
                ...
                <div class="modal-footer ">
                    <button type="submit" class="btn btn-primary" onclick="add_assistant()">إضافة مساعد إداري</button>
