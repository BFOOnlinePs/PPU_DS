            ...
            <div class="f1" id="companyForm">
                ...
                <div class="stepwizard mt-5">
                    <div class="stepwizard-row setup-panel">
                        <div class="stepwizard-step"><button class="btn btn-primary" id="btn1" onclick="info()"><i
                                    class="fa fa-file-text-o"></i></button>
                            <p>{{ __('translate.Company Information') }}{{-- معلومات الشركة --}}</p>
                        </div>
                        <div class="stepwizard-step"><button class="btn btn-light" id="btn2" onclick="department()"><i
                                    class="fa fa-th-large"></i></button>
                            <p>{{ __('translate.Company Departments') }}{{-- أقسام الشركة --}}</p>
                        </div>
                        <div class="stepwizard-step"><button class="btn btn-light" id="btn3" onclick="branch()"><i
                    ...
                    <form id="EditCompanyInfo" method="post">
                        ...
                        <div id="editCompanyForm">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="f1-first-name"> {{ __('translate.Company Name') }} <span
                                                style="color: red">*</span> {{-- اسم الشركة --}}</label>
                                        ...
                                        <div class="input-container">
                                            ...
                                            <input class="form-control required" type="text" id="c_name"
                                                name="c_name" value="{{ $company->c_name }}"
                                                onkeyup="checkCompany(this.value)">
                                        </div>
                                        ...
                                        <div id="similarCompanyMessage" style="color:#dc3545" hidden>
                                            ...
                                            <u><a id="companyLink"
                                                    style="color:#dc3545">{{ __('translate.To move to the edit click here') }}'{{-- للانتقال إلى التعديل قم بالضغط هنا --}}</a></u>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="f1-last-name">{{ __('translate.Owner') }} <span
                                                style="color: red">*</span> {{-- الشخص المسؤول --}}</label>
                                        <input class="f1-last-name form-control required" id="name" type="text"
                                            name="name" value="{{ $company->manager->name }}">
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="f1-last-name">{{ __('translate.Company Phone Number') }} <span
                                                style="color: red">*</span>{{-- رقم هاتف الشركة --}}</label>
                                        <input class="f1-last-name form-control required" id="phoneNum" type="text"
                                            name="phoneNum" value="{{ $company->manager->u_phone1 }}"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class=" mb-3 form-group">
                                        <label for="f1-first-name"> {{ __('translate.Email') }} <span
                                                style="color: red">*</span> {{-- البريد الإلكتروني --}} </label>
                                        ...
                                        <div class="input-container">
                                            ...
                                            <input class="form-control required" id="email" type="text"
                                                name="email" value="{{ $company->manager->email }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="f1-last-name">{{ __('translate.Password') }}
                                            {{-- كلمة المرور --}}</label>
                                        <input class="f1-password form-control " id="password" type="password"
                                            name="password">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="f1-last-name">{{ __('translate.Company Address') }}<span
                                                style="color: red">*</span>{{-- عنوان الشركة --}} </label>
                                        <input class="f1-last-name form-control required" id="address" type="text"
                                            name="address" value="{{ $company->manager->u_address }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="f1-last-name">{{ __('translate.Company Type') }} <span
                                                style="color: red">*</span>{{-- نوع الشركة --}}</label>
                                        <select id="c_type" name="c_type" class="form-control btn-square"
                                            value="{{ $company->c_type }}">
                                            <option @if ($company->c_type == 1) selected @endif value="1">
                                                {{ __('translate.Public Sector') }}{{-- قطاع عام --}}</option>
                                            <option @if ($company->c_type == 2) selected @endif value="2">
                                                {{ __('translate.Private Sector') }}{{-- قطاع خاص --}}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="f1-last-name">{{ __('translate.Company Category') }} <span
                                                style="color: red">*</span> {{-- تصنيف الشركة --}}</label>
                                        <select id="c_category" name="c_category" class="form-control btn-square"
                                            value="{{ $company->c_category_id }}">
                                            @foreach ($categories as $key)
                                                <option value="{{ $key->cc_id }}"
                                                    @if ($company->c_category_id == $key->cc_id) selected @endif>{{ $key->cc_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label
                                            for="f1-last-name">{{ __('translate.Website') }}{{-- الموقع الإلكتروني --}}</label>
                                        <input class="form-control" id="c_website" name="c_website"
                                            value="{{ $company->c_website }}" oninput="validateArabicText(this)">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label
                                            for="f1-last-name">{{ __('translate.Company Description') }}{{-- وصف الشركة --}}</label>
                        ...
                        <div class="f1-buttons">
                            <button type="submit" id="submit_editCompany"
                                class="btn btn-primary">{{ __('translate.Edit') }}{{-- تعديل --}}</button>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    <form id="addDepartment" method="post">
                                        ...
                                        <label for="f1-first-name">
                                            {{ __('translate.Department Name') }}{{-- اسم القسم --}}</label>
                                        <input class="form-control" id="d_name" name="d_name">
                                        <input class="form-control" id="d_company_id" name="d_company_id"
                                            value="{{ $company->c_id }}" hidden>
                                    </form>
                            ...
                            <div class="col-md-4" style="margin-top: 26px;">
                                <button class="btn btn-info" type="button"
                                    onclick="addDepartment()">{{ __('translate.Add Department') }}{{-- إضافة القسم --}}</button>
                            </div>
                        </div>
                        ...
                        <div class="card card-absolute" id="departments_summary_area_company">
                            <div class="card-body">
                                <div class="card-header bg-primary">
                                    <h5 class="text-white">{{ __('translate.Company Departments') }}{{-- أقسام الشركة --}}
                                    </h5>
                                </div>
                                        ...
                                        <div class="row">
                                            <form id="EditCompanyDepartments" method="post">
                                                ...
                                                <div id="DepartmentList">
                                                    <input id="companyDepartments" name="companyDepartments"
                                                        value="{{ $companyDepartments }}" hidden>
                                                    @foreach ($companyDepartments as $key1)
                                                        <input hidden id="d_id" name="d_id"
                                                            value="{{ $key1->d_id }}">
                                                        <div class="col-md-8">
                                                            <input class="f1-last-name form-control"
                                                                name="d_name_{{ $key1->d_id }}"
                                                                id="d_name_{{ $key1->d_id }}"
                                                                value="{{ $key1->d_name }}">
                                                        </div>
                                                        <br>
                                                    @endforeach
                                                    <input hidden id="c_id" name="c_id"
                                                        value="{{ $company->c_id }}">
                                                </div>
                ...
                <div id="branch" hidden>
                    <div>
                        <button class="btn btn-primary  mb-2 btn-s" type="button" onclick='addBranch()'><span
                                class="fa fa-plus"></span> {{ __('translate.Add Branch') }}{{-- إضافة فرع --}}</button>
                    </div>
                    <div class="row" id="companyBranches">
                        <input hidden id="branches" name="branches" value="{{ $company->companyBranch }}">
                        <input id="companyDepartments1" name="companyDepartments1" value="{{ $companyDepartments }}"
                            hidden>
                                        ...
                                        <form id="EditCompanyBranches_{{ $key->b_id }}" method="POST">
                                            ...
                                            <div class="ribbon ribbon-primary ribbon-right">
                                                @if ($key->b_main_branch == 1)
                                                    {{ __('translate.Main Branch') }}{{-- الفرع الرئيسي --}}
                                                @else
                                                    {{ __('translate.Branch') }} {{-- الفرع --}}
                                                    {{ $loop->index++ }}
                                                @endif
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="phone1">{{ __('translate.Phone 1') }}<span
                                                                style="color: red">*</span>{{-- هاتف 1 --}}</label>
                                                        <input class="f1-last-name form-control"
                                                            id="phone1_{{ $key->b_id }}" type="text"
                                                            name="phone1_{{ $key->b_id }}"
                                                            value="{{ $key->b_phone1 }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label
                                                            for="phone2">{{ __('translate.Phone 2') }}{{-- هاتف 2 --}}</label>
                                                        <input class="f1-last-name form-control"
                                                            id="phone2_{{ $key->b_id }}"
                                                            name="phone2_{{ $key->b_id }}"
                                                            value="{{ $key->b_phone2 }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label
                                                            for="address">{{ __('translate.Branch Address') }}{{-- عنوان الفرع --}}</label>
                                                        <input class="f1-last-name form-control"
                                                            id="address_{{ $key->b_id }}" type="text"
                                                            name="address_{{ $key->b_id }}"
                                                            value="{{ $key->b_address }}">
                                                    </div>
                                                </div>
                                                <input hidden id="department_for_1_{{ $key->b_id }}"
                                                    name="department_for_1_{{ $key->b_id }}">
                                                <input hidden id="c_id_{{ $key->b_id }}"
                                                    name="c_id_{{ $key->b_id }}" value="{{ $company->c_id }}">
                                                <input hidden id="manager_id_{{ $key->b_id }}"
                                                    name="manager_id_{{ $key->b_id }}"
                                                    value="{{ $company->c_manager_id }}">
                                                <input hidden id="b_id" name="b_id" value="{{ $key->b_id }}">
                                                <input hidden id="companyDep_{{ $key->b_id }}"
                                                    name="companyDep_{{ $key->b_id }}"
                                                    value="{{ $key->companyBranchDepartments }}">
                                                <input hidden id="departmentSelectedList_{{ $key->b_id }}"
                                                    name="departmentSelectedList_{{ $key->b_id }}">
                                                <div class="col-md-6">
                                                    <div class="form-group" id="departments_group1_{{ $key->b_id }}">
                                                        <input hidden id="branchesNumber_{{ $key->b_id }}"
                                                            name="branchedNumber_{{ $key->b_id }}"
                                                            value="{{ count($company->companyBranch) }}">
                                                        <label
                                                            for="departments_{{ $key->b_id }}">{{ __('translate.Branch Departments') }}{{-- أقسام الفرع --}}</label>
                                                        <select class="js-example-basic-single col-sm-12"
                                                            multiple="multiple" id="departments_{{ $key->b_id }}"
                                                            multiple>
                                                            @foreach ($companyDepartments as $key2)
                                                                <option
                                                                    value="{{ $key2->d_id }}"@foreach ($key->companyBranchDepartments as $key3) @if ($key3->cbd_d_id == $key2->d_id) selected @endif @endforeach>
                                                                    {{ $key2->d_name }} </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="f1-buttons">
                                                <button id="submit_{{ $key->b_id }}"
                                                    onclick="submitEditCompanyBranches({{ $key->b_id }})"
                                                    class="btn btn-primary"
                                                    type="button">{{ __('translate.Edit') }}{{-- تعديل --}}</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
    ...
    <script>
            ...
            if (data != "") {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.data != null && response.company_name != document.getElementById('c_name')
                            .value) {
        ...
        function addDepartment() {
            ...
            if (departmentName != "" && !departmentNames.includes(departmentName)) {
                ...
                if (departmentName == "") {
                    ...
                    document.querySelector('#similarCompanyDepMessage span').textContent =
                        '{{ __('translate.Please fill out the field') }}';


                } else {
                    document.getElementById('similarCompanyDepMessage').hidden = false;
                    document.querySelector('#similarCompanyDepMessage span').textContent =
                        '{{ __('translate.There is department with the same name you entered') }}';
                }
            }
        ...
        function deleteDepartment(i) {
            ...
            for (i = 0; i < departments.length; i++) {
                x = x +
                    '<br> <div class="row"> <div class="col-md-8"> <div class="form-group"><input class="f1-last-name form-control" id="d_name"  value="' +
                    departments[i] + '"> </div></div>' +
                    '<div class="col-md-4" ><button class="btn btn-danger" onclick="deleteDepartment(' + i +
