...
<div class="card" style="padding-left:0px; padding-right:0px;">
    ...
    <div class="card-body" >
        ...
        <form class="row" action='{{ route('admin.companies.create') }}' method="post">
            @csrf
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="mobile" placeholder="تخزن رقم الهاتف اذا كانت فارغة" class="form-control"/>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
