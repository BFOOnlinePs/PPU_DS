                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="c_criteria_name" placeholder="اسم المعيار">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">علامة المعيار</label>
                                    <input type="text" name="c_max_score" class="form-control" placeholder="علامة المعيار">
                                </div>
                            </div>
                            <div class="col-md-12">
