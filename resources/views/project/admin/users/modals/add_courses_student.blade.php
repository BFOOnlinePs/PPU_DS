        ...
        <div class="modal-content" style="border: none;">
            <div class="modal-header" style="height: 73px;">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="mb-3 row">
                                            ...
                                            <select autofocus class="js-example-basic-single col-sm-12" name="c_id">
                ...
                <div class="modal-footer ">
                    <button type="submit" class="btn btn-primary" id="button_add_user_in_modal">تسجيل المساق</button>
