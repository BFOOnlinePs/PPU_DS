                ...
                <div class="modal-body">
                    <div class="row p-3 m-5">
                        <div class="col-md-3 text-center" >
                            ...
                            <h3>الخريطة</h3>
                            <hr>
                            <p>في هذا القسم يمكنك رؤية موقع الطالب على الخريطة عند تسجيل الحضور و المغادرة</p>
                        </div>
                        <div class="col-md-9">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3 row">
                                            <div class="col-md-6 p-3">
                                                <div class="mb-3 row">
                                                    <label for="attendance-map" class="col-md-12">موقع الطالب عند تسجيل الحضور</label>
                                            ...
                                            <div class="col-md-6 p-3">
                                                <div class="mb-3 row">
                                                <label for="absence-map" class="col-md-12">موقع الطالب عند تسجيل المغادرة</label>
