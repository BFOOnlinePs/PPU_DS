        ...
        <div class="modal-content" style="border: none;">
            <div class="modal-header" style="height: 73px;">
                ...
                <div class="modal-body">
                    <div class="row p-3 m-5">
                        <div class="col-md-4 text-center" >
                            ...
                            <h3>تسجيل مشرف أكاديمي لمساعد إداري</h3>
                            <hr>
                            <p >في هذا القسم يمكن تسجيل مشرف أكاديمي يكون تابع للمساعد إداري</p>
                        </div>
                        <div class="col-md-8">
                            <form class="form-horizontal" id="addSupervisorForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3 row">
                                            <label for="">المشرف الأكاديمي</label>
                ...
                <div class="modal-footer ">
                    <button type="button" class="btn btn-primary" onclick="add_supervisor({{$user->u_id}})">تسجيل مشرف أكاديمي</button>
