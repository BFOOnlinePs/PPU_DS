                ...
                <tr>
                    ...
                    <td>
                        @if (!empty($studentCompany->sc_agreement_file))
                            <a href="{{ asset($studentCompany->sc_agreement_file) }}" class="btn btn-primary fa fa-download btn-xs"  type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="تنزيل ملف الموافقة" download></a>
                            <a onclick="viewAttachment('{{ asset($studentCompany->sc_agreement_file) }}')" class="btn btn-primary fa fa-file btn-xs" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="عرض ملف الموافقة"></a>
