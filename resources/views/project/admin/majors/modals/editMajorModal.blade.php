                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-12">
                                                       <input id="edit_m_name" type="text" class="form-control @error('edit_m_name') is-invalid @enderror btn-square input-md"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-12">
                                                    <input id="edit_m_description" type="text" class="form-control @error('m_description') is-invalid @enderror btn-square input-md" name="m_description"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-12">
                                                      <input id="edit_m_reference_code" type="text" class="form-control @error('m_reference_code') is-invalid @enderror btn-square input-md"
                                                        name="m_reference_code" value="{{ old('m_reference_code') }}" required autofocus>
