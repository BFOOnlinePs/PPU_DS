...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'monitor_evaluation', 'middleware' => 'role:1|3|5|8'], function () {
    ...
    Route::group(['prefix' => 'supervisors'], function () {
        ...
        Route::group(['prefix' => 'training_nominations', 'middleware' => 'role:4|8'], function () {
...
// export data
Route::get('/export-companies', [App\Http\Controllers\project\settings\ExportDataController::class, 'exportCompanies'])->name('export_companies');

// import data
Route::get('/import-data', [App\Http\Controllers\project\settings\ImportDataController::class, 'importData'])->name('import_data');
